                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/tambahguru') ?>" method="post">
                        <div class="form-group">
                            ...
                            <input value="<?= set_value('nama_guru') ?>" type="text" name="nama_guru" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mapel" value="<?= set_value('mapel') ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
